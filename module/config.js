...
HM3.stdSkills = {
    Sword: {
        ...
        skillBase: { formula: "@str, @dex, @dex, Angberelius:3, Ahnu, Nadai" },
        type: "Combat",
    },
    Axe: {
        source: "HM3 Skills 19",
        skillBase: { formula: "@str, @str, @dex, Ahnu, Feniri, Angberelius" },
        type: "Combat",
    },
    Bow: {
        source: "HM3 Skills 19",
        skillBase: { formula: "@str, @dex, @eye, Hirin, Tarael, Nadai" },
        type: "Combat",
    },
    Shield: {
        source: "HM3 Skills 19",
        skillBase: { formula: "@str, @dex, @dex, Ulandus, Lado, Masara" },
        type: "Combat",
    },
    Flail: {
        source: "HM3 Skills 19",
        skillBase: { formula: "@dex, @dex, @dex, Hirin, Tarael, Nadai" },
        type: "Combat",
    },
    Sling: {
        source: "HM3 Skills 19",
        skillBase: { formula: "@dex, @dex, @eye, Hirin, Tarael, Nadai" },
        type: "Combat",
    },
    Riding: {
        source: "HM3 Skills 18",
        skillBase: { formula: "@dex, @agl, @wil, Ulandus, Aralius" },
        type: "Combat",
    },
    Initiative: {
        source: "HM3 Skills 18",
        skillBase: { formula: "@agl, @wil, @wil" },
        type: "Combat",
    },
    Unarmed: {
        source: "HM3 Skills 18",
        skillBase: { formula: "@str, @dex, @agl, Madada:2, Lado:2, Ulandus:2" },
        type: "Combat",
    },
    Polearm: {
        source: "HM3 Skills 19",
        skillBase: { formula: "@str, @str, @dex, Angberelius, Aralius" },
        type: "Combat",
    },
    Dagger: {
        source: "HM3 Skills 19",
        skillBase: { formula: "@dex, @dex, @eye, Angberelius:2, Nadai:2" },
        type: "Combat",
    },
    Blowgun: {
        source: "HM3 Skills 19",
        skillBase: { formula: "@sta, @dex, @eye, Hirin:2, Tarael, Nadai" },
        type: "Combat",
    },
    Spear: {
        source: "HM3 Skills 19",
        skillBase: { formula: "@str, @str, @dex, Aralius, Feniri, Ulandus" },
        type: "Combat",
    },
    Net: {
        source: "HM3 Skills 19",
        skillBase: { formula: "@dex, @dex, @eye, Masara, Skorus, Lado" },
        type: "Combat",
    },
    Club: {
        source: "HM3 Skills 19",
        skillBase: { formula: "@str, @str, @dex, Ulandus, Aralius" },
        type: "Combat",
    },
    Whip: {
        source: "HM3 Skills 19",
        skillBase: { formula: "@dex, @dex, @eye, Hirin, Nadai" },
        type: "Combat",
    },
    Dodge: { source: "HM3 Skills 21", skillBase: { formula: "@agl, @agl, @agl" }, type: "Combat" },
    Acting: {
        source: "HM3 Skills 11",
        skillBase: { formula: "@agl, @voi, @int, Tarael, Tai" },
        type: "Communication",
    },
    Intrigue: {
        source: "HM3 Skills 11",
        skillBase: { formula: "@int, @aur, @wil, Tai, Tarael, Skorus" },
        type: "Communication",
    },
    Awareness: {
        source: "HM3 Skills 11",
        skillBase: { formula: "@eye, @hrg, @sml, Hirin:2, Tarael:2" },
        type: "Communication",
    },
    Oratory: {
    ...
    Rhetoric: {
        source: "HM3 Skills 12",
        skillBase: { formula: "@voi, @int, @wil, Tai, Tarael, Skorus" },
        type: "Communication",
    },
    Language: {
        source: "HM3 Skills 10",
        skillBase: { formula: "@voi, @int, @wil, Tai" },
        type: "Communication",
    },
    Musician: {
        source: "HM3 Skills 12",
        skillBase: { formula: "@dex, @hrg, @hrg, Masara, Angberelius" },
        type: "Communication",
    },
    "Mental Conflict": {
        source: "HM3 Skills 12",
        skillBase: { formula: "@aur, @wil, @wil" },
        type: "Communication",
    },
    Singing: {
        source: "HM3 Skills 12",
        skillBase: { formula: "@hrg, @voi, @voi, Masara" },
        type: "Communication",
    },
    Lovecraft: {
        source: "HM3 Skills 11",
        skillBase: { formula: "@cml, @agl, @voi, Masara, Angberelius" },
        type: "Communication",
    },
    Physician: {
        source: "HM3 Skills 17",
        skillBase: { formula: "@dex, @eye, @int, Masara:2, Skorus, Tai" },
        type: "Craft",
    },
    Fishing: {
        source: "HM3 Skills 14",
        skillBase: { formula: "@dex, @eye, @wil, Masara:2, Lado:2" },
        type: "Craft",
    },
    Survival: {
        source: "HM3 Skills 17",
        skillBase: { formula: "@str, @dex, @int, Ulandus:2, Aralius" },
        type: "Craft",
    },
    Foraging: {
        source: "HM3 Skills 15",
        skillBase: { formula: "@dex, @sml, @int, Ulandus:2, Aralius:2" },
        type: "Craft",
    },
    Mathematics: {
        source: "HM3 Skills 16",
        skillBase: { formula: "@int, @int, @wil, Tai:3, Tarael, Skorus" },
        type: "Craft",
    },
    Folklore: {
        source: "HM3 Skills 15",
        skillBase: { formula: "@voi, @int, @int, Tai:2" },
        type: "Craft",
    },
    Jewelcraft: {
        source: "HM3 Skills 16",
        skillBase: { formula: "@dex, @eye, @wil, Feniri:3, Tarael, Aralius" },
        type: "Craft",
    },
    Tracking: {
        source: "HM3 Skills 17",
        skillBase: { formula: "@eye, @sml, @wil, Ulandus:3, Aralius:3" },
        type: "Craft",
    },
    Hunting: {
        source: "HM3 Skills 16",
        skillBase: { formula: "@agl, @sml, @int, Ulandus:2, Aralius:2" },
        type: "Craft",
    },
    Law: {
        source: "HM3 Skills 16",
        skillBase: { formula: "@voi, @int, @wil, Tarael, Tai" },
        type: "Craft",
    },
    Weaponcraft: {
        source: "HM3 Skills 17",
        skillBase: { formula: "@str, @dex, @wil, Feniri:3, Ahnu, Angberelius" },
        type: "Craft",
    },
    Mining: {
        source: "HM3 Skills 16",
        skillBase: { formula: "@str, @eye, @int, Ulandus:2, Aralius:2, Feniri" },
        type: "Craft",
    },
    Metalcraft: {
        source: "HM3 Skills 16",
    ...
    Ceramics: {
        ...
        skillBase: { formula: "@dex, @dex, @eye, Ulandus:2, Aralius:2" },
        type: "Craft",
    },
    Runecraft: {
        source: "HM3 Skills 17",
        skillBase: { formula: "@int, @aur, @aur, Tai:2, Skorus" },
        type: "Craft",
    },
    Tarotry: {
        source: "HM3 Skills 17",
        skillBase: { formula: "@int, @aur, @wil, Tarael:2, Tai:2, Skorus, Hirin" },
        type: "Craft",
    },
    Perfumery: {
        source: "HM3 Skills 16",
        skillBase: { formula: "@sml, @sml, @int, Hirin, Skorus, Tarael" },
        type: "Craft",
    },
    Fletching: {
        source: "HM3 Skills 15",
        skillBase: { formula: "@dex, @dex, @eye, Hirin:2, Tarael, Nadai" },
        type: "Craft",
    },
    Piloting: {
        source: "HM3 Skills 17",
        skillBase: { formula: "@dex, @eye, @int, Lado:3, Masara" },
        type: "Craft",
    },
    Weatherlore: {
        source: "HM3 Skills 17",
        skillBase: { formula: "@int, @eye, @sml, Hirin, Tarael, Masada, Lado" },
        type: "Craft",
    },
    Engineering: {
        source: "HM3 Skills 14",
        skillBase: { formula: "@dex, @int, @int, Ulandus:2, Aralius:2, Feniri" },
        type: "Craft",
    },
    Embalming: {
        source: "HM3 Skills 14",
        skillBase: { formula: "@dex, @eye, @sml, Skorus, Ulandus" },
        type: "Craft",
    },
    Brewing: {
        source: "HM3 Skills 13",
        skillBase: { formula: "@dex, @sml, @sml, Skorus:3, Tai:2, Masara:2" },
        type: "Craft",
    },
    Lockcraft: {
        source: "HM3 Skills 16",
        skillBase: { formula: "@dex, @eye, @wil, Feniri" },
        type: "Craft",
    },
    Masonry: {
        source: "HM3 Skills 16",
        skillBase: { formula: "@str, @dex, @int, Ulandus:2, Aralius:2" },
        type: "Craft",
    },
    Textilecraft: {
        source: "HM3 Skills 17",
        skillBase: { formula: "@dex, @dex, @eye, Ulandus, Aralius" },
        type: "Craft",
    },
    Cookery: {
        source: "HM3 Skills 13",
        skillBase: { formula: "@dex, @sml, @sml, Skorus" },
        type: "Craft",
    },
    Lore: {
        source: "HM3 Skills 16",
        skillBase: { formula: "@eye, @int, @int, Tai:2" },
        type: "Craft",
    },
    Drawing: {
        source: "HM3 Skills 13",
        skillBase: { formula: "@dex, @eye, @eye, Skorus, Tai" },
        type: "Craft",
    },
    Alchemy: {
        source: "HM3 Skills 13",
        skillBase: { formula: "@sml, @int, @aur, Skorus:3, Tai:2, Masara:2" },
        type: "Craft",
    },
    Milling: {
        source: "HM3 Skills 16",
        skillBase: { formula: "@str, @dex, @sml, Ulandus" },
        type: "Craft",
    },
    Timbercraft: {
        source: "HM3 Skills 17",
        skillBase: { formula: "@str, @dex, @agl, Ulandus:3, Aralius" },
        type: "Craft",
    },
    Hidework: {
        source: "HM3 Skills 15",
        skillBase: { formula: "@dex, @sml, @wil, Ulandis, Aralius" },
        type: "Craft",
    },
    Shipwright: {
        source: "HM3 Skills 17",
        skillBase: { formula: "@str, @dex, @int, Lado:3, Masara" },
        type: "Craft",
    },
    Astrology: {
        source: "HM3 Skills 13",
        skillBase: { formula: "@eye, @int, @aur, Tarael" },
        type: "Craft",
    },
    Woodcraft: {
        source: "HM3 Skills 17",
        skillBase: { formula: "@dex, @dex, @wil, Ulandus:2, Aralius, Lado" },
        type: "Craft",
    },
    Herblore: {
        source: "HM3 Skills 15",
        skillBase: { formula: "@eye, @sml, @int, Ulandus:3, Aralius:2" },
        type: "Craft",
    },
    Inkcraft: {
        source: "HM3 Skills 16",
        skillBase: { formula: "@eye, @sml, @int, Skorus:2, Tai" },
        type: "Craft",
    },
    Heraldry: {
        source: "HM3 Skills 15",
        skillBase: { formula: "@dex, @eye, @wil, Skorus, Tai" },
        type: "Craft",
    },
    Animalcraft: {
        source: "HM3 Skills 13",
        skillBase: { formula: "@agl, @voi, @wil, Ulandus, Aralius" },
        type: "Craft",
    },
    Seamanship: {
        source: "HM3 Skills 17",
        skillBase: { formula: "@str, @dex, @agl, Lado:3, Masara, Skorus" },
        type: "Craft",
    },
    Glassworking: {
        source: "HM3 Skills 15",
        skillBase: { formula: "@dex, @eye, @wil, Feniri:2" },
        type: "Craft",
    },
    Agriculture: {
        source: "HM3 Skills 13",
        skillBase: { formula: "@str, @sta, @wil, Ulandus:2, Aralius:2" },
        type: "Craft",
    },
    Lyahvi: {
    ...
    Climbing: {
        source: "HM3 Skills 8",
        skillBase: { formula: "@str, @dex, @agl, Ulandus:2, Aralius:2" },
        type: "Physical",
    },
    Swimming: {
        source: "HM3 Skills 9",
        skillBase: { formula: "@sta, @dex, @agl, Skorus, Masara:3, Lado:3" },
        type: "Physical",
    },
    Skiing: {
        source: "HM3 Skills 9",
        skillBase: { formula: "@str, @dex, @agl, Masara:2, Skorus, Lado" },
        type: "Physical",
    },
    Stealth: {
        source: "HM3 Skills 9",
        skillBase: { formula: "@agl, @hrg, @wil, Hirin:2, Tarael:2, Tai:2" },
        type: "Physical",
    },
    Jumping: {
        source: "HM3 Skills 9",
        skillBase: { formula: "@str, @agl, @agl, Nadai:2, Hirin:2" },
        type: "Physical",
    },
    Condition: {
        source: "HM3 Skills 9",
        skillBase: { formula: "@str, @sta, @wil, Ulandus, Lado" },
        type: "Physical",
    },
    Dancing: {
        source: "HM3 Skills 9",
        skillBase: { formula: "@Dex, @agl, @agl, Tarael:2, Hirin, Tai" },
        type: "Physical",
    },
    Acrobatics: {
        source: "HM3 Skills 8",
        skillBase: { formula: "@str, @agl, @agl, Nadai:2, Hirin" },
        type: "Physical",
    },
    Throwing: {
        source: "HM3 Skills 10",
        skillBase: { formula: "@str, @dex, @eye, Hirin:2, Tarael, Nadai" },
        type: "Physical",
    },
    Legerdemain: {
        source: "HM3 Skills 9",
        skillBase: { formula: "@dex, @dex, @wil, Skorus:2, Tai:2, Tarael:2" },
        type: "Physical",
    },
    Peoni: {
        source: "HM Religion, Peoni 1",
        skillBase: { formula: "@voi, @int, @dex, Aralius:2, Angberelius, Ulandus" },
        type: "Ritual",
    },
    Agrik: {
        source: "HM Religion, Agrik 1",
        skillBase: { formula: "@voi, @int, @str, Nadai:2, Angberelius, Ahnu" },
        type: "Ritual",
    },
    Ilvir: {
        source: "HM Religion, Ilvir 1",
        skillBase: { formula: "@voi, @int, @aur, Skorus:2, Tai, Ulandus" },
        type: "Ritual",
    },
    Siem: {
        source: "HM Religion, Siem 1",
        skillBase: { formula: "@voi, @int, @aur, Hirin:2, Feniri, Ulandus" },
        type: "Ritual",
    },
    Sarajin: {
        source: "HM Religion, Sarajin 1",
        skillBase: { formula: "@voi, @int, @str, Feniri:2, Aralius, Lado" },
        type: "Ritual",
    },
    Morgath: {
        source: "HM Religion, Morgath 1",
        skillBase: { formula: "@voi, @int, @aur, Lado:2, Ahnu, Masara" },
        type: "Ritual",
    },
    Halea: {
        source: "HM Religion, Halea 1",
        skillBase: { formula: "@voi, @int, @cml, Tarael:2, Hirin, Masara" },
        type: "Ritual",
    },
    Naveh: {
        source: "HM Religion, Naveh 1",
        skillBase: { formula: "@voi, @int, @wil, Masara:2, Skorus, Tarael" },
        type: "Ritual",
    },
    Larani: {
        source: "HM Religion, Larani 1",
        skillBase: { formula: "@voi, @int, @wil, Angberelius:2, Ahnu, Feniri" },
        type: "Ritual",
    },
    "Save K'nor": {
        source: "HM Religion, Save K'nor 1",
        skillBase: { formula: "@voi, @int, @int, Tai:2, Tarael, Skorus" },
        type: "Craft",
    },
};
